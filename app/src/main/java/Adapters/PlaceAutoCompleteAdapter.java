...
import com.engineering.nhub.ancaps_project.HomePage;
...
implements Filterable{
     ...
     */
    public PlaceAutoCompleteAdapter(HomePage context, int resource, GoogleApiClient googleApiClient,
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            if (!status.isSuccess()) {
                MDToast.makeText(getContext(), "Check Internet Connection", MDToast.LENGTH_SHORT,
                        MDToast.TYPE_ERROR).show();
//                Toast.makeText(getContext(), "Error contacting API: " + status.toString(),
//                        Toast.LENGTH_SHORT).show();

//                new SweetAlertDialog(getContext().getApplicationContext(), SweetAlertDialog.WARNING_TYPE)
//                        .setTitleText("Error")
//                        .setContentText("Check Network Connection")
//                        .setConfirmText("OK")
